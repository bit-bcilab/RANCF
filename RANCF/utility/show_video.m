...
%   http://www.isr.uc.pt/~henriques/
	...
	function redraw(frame)
		...
		if isempty(rect_h1),  %create it for the first time
            ...
            rect_h2 = rectangle('Position',[0,0,1,1], 'EdgeColor','r');
        end
		if ~isempty(boxes{frame}),
			set(rect_h1, 'Visible', 'on', 'Position', boxes{frame,1});
            set(rect_h2, 'Visible', 'on', 'Position', boxes{frame,2});
		else
